export default function AboutMe() {
  return (
    ...
    >
      <div className="flex border mb-6 border-line w-36 justify-between rounded-3xl px-4 py-1">
        <svg
      ...
      <div className="flex justify-center flex-col">
        <h1 className="mb-10 lg:mt-20 font-sans  text-3xl tracking-wide font-bold text-text-color sm:text-5xl sm:leading-none">
          Every Line of Code Tells a <br />
          <span className="text-accent-color">Captivating Story</span>
        </h1>
        <h3 className="inline-block max-w-5xl opacity-75 tracking-widest text-justify text-base text-maven-blue">
        ...
        <br />
        <h3 className="inline-block mt-10 max-w-5xl opacity-75 tracking-widest text-justify text-base text-maven-blue">
