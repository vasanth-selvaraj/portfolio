          ...
          <ul className="flex flex-col py-2">
            ...
            <li className="py-4 relative group">
              <Link href="/#github">
                ...
                <span className="absolute hidden group-hover:flex w-18 top-[25%] -left-5 -translate-x-full px-2 py-1 bg-gray-700 rounded-lg text-center text-white text-sm before:content-[''] before:absolute before:top-1/2 before:left-[100%] before:-translate-y-1/2 before:border-[7px] bg-[#404042] before:border-y-transparent before:border-r-transparent before:border-l-[#404042]">
                  Github
                </span>
              </Link>
            </li>
